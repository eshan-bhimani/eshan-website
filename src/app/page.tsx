...
function HeroSection() {
  const { displayed, done } = useTypingAnimation("Eshan Bhimani", 95, 400);
  const showSub = displayed.length >= 5;
            ...
            <AnimatePresence>
              {done && (
                ...
                >
                  ...
                  <div className="mt-7 flex items-center justify-center md:justify-start gap-2 text-sm text-text-muted">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {items.map((skill) => (
                    <span
                      key={skill}
                      className="inline-flex items-center rounded-lg border border-border bg-surface/50 px-3 py-1.5 text-xs font-mono text-text-secondary hover:border-border-light hover:text-text-primary transition-colors cursor-default"
                    >
                      {skill}
                    </span>
                  ))}
